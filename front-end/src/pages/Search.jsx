...
//                                 Prix le + cher en premier
//                             </option>
//                             <option value="price_desc">
//                                 Prix le - cher en premier
//                             </option>
//                             <option value="created_at_desc">
//                                 Annonce plus récente
//                             </option>
//                             <option value="created_at_asc">
//                                 Annonce plus ancienne
//                             </option>
//                         </select>
//                     </div>
...
//                     )}
//                     {/* {loading && (
//                         <p className="text-center w-full text-slate-700 text-xl">
//                             Rechargement...
//                         </p>
//                     )} */}
//                     {!loading &&
            ...
            <div className="flex-1">
                ...
                <div className="p-7 flex flex-wrap gap-4">
                    ...
                    {!loading && Array.isArray(listings) && listings.length > 0
                        ...
                        : !loading && <p>Aucune annonce trouvée.</p>}
                    {showMore && (
                        <button
